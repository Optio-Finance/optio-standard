...
func mulDivDown{range_check_ptr}(x: Uint256, y: Uint256, denominator: Uint256) -> (z: Uint256) {
    alloc_locals;
...
func mulDivUp{range_check_ptr}(x: Uint256, y: Uint256, denominator: Uint256) -> (z: Uint256) {
    alloc_locals;
    let ZERO = Uint256(0, 0);
    let ONE = Uint256(1, 0);
